...
| 多选操作 | Ctrl+点击便签列表项，底部浮栏批量归档/改色/删除 |
| 搜索便签 | Hub 设置中心顶部搜索框，FTS5 全文检索 + 关键词高亮 |
| 便签模板 | Hub → 📋 模板按钮，新建/编辑/删除模板，一键创建便签 |
| 切换 Hub | Ctrl+Shift+H 全局显示/隐藏设置中心 |
