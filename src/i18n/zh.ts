export default {
  ...
  hub: {
    ...
    aboutSlogan: '贴出来，想得到',
    aboutEdit: '编辑',
    aboutEditDesc: 'Markdown 实时渲染 · 图片拖入 · 待办清单 · 标签 · 模板',
    aboutRemind: '提醒',
    aboutRemindDesc: '一次/每天/每周/每月/农历 · 日历视图 · 闪烁通知',
    aboutAiDesc: '分析 · 重写 · 排序 · 周报 · 可关闭可替换',
    aboutSync: '同步',
    aboutSyncDesc: 'Git 多设备同步 · 本地 SQLite · 数据完全本地',
    aboutShortcuts: '快捷键',
    aboutScNew: '新建便签',
    aboutScShow: '显示全部',
    aboutScHub: '切换 Hub',
    aboutScSave: '保存',
    aboutScNewNote: '便签内新建',
    aboutScEsc: '退出编辑',
    checkUpdate: '检查更新',
    updateChecking: '检查中...',
    updateFound: '发现新版本',
    ...
    sniffFailed: 'AI 分析失败',
    sniffDisabled: '嗅探未启用，请在 AI 设置中开启',
    executeFailed: '执行失败',
